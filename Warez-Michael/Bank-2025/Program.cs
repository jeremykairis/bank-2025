...
CurrentAccount account1 = new CurrentAccount("ACC123", 1000.0, 500.0, person1) { lignecredit = 500.0 };
CurrentAccount account2 = new CurrentAccount("ACC456", 2000.0, 1000.0, person2) { lignecredit = 1000.0 };
